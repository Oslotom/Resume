...
export const initialCVData: CVData = {
  ...
  personal: {
    name: "TOM HAUGEPLASS",
    title: "ENDRINGSLEDELSE · KOORDINERING · IT",
    subtitle: "OM MEG",
    summary: "IT- og produktleder med lang erfaring i å koordinere tekniske endringer, lanseringer og leveranser på tvers av utvikling, drift, support og forretning — fra risikovurdering og avhengigheter til testing, produksjonssetting og evaluering. Teknisk fundament fra fagbrev i IKT-driftsfag, og bred erfaring fra oppstartsselskaper og globale selskaper. Søker nå en rolle innen endringsledelse og kvalitetssikring. Tilgjengelig på kort varsel.",
    contact: {
      location: "Oslo",
      phone: "+47 472 34 017",
  ...
  experience: [
    {
      ...
      period: "2025 – 2026",
      description: "Vurderte og konseptualiserte nye produktlinjer for algoritmisk handelsselskap, basert på selskapets handelsdata — blant annet utredning av en mulig handelsplattform, med behovsavklaring, risikovurdering og beslutningsgrunnlag for ledelsens veivalg.",
      bullets: ["Bygget prototyper med AI-verktøy (Claude, Google AI Studio, Lovable, Bolt) i utforskningen."]
    },
    {
      id: "exp2",
      ...
      period: "2022 – 2025",
      description: "Ansvar for å koordinere og kvalitetssikre lokale endringer i en global plattform med over 1 million norske brukere.",
      bullets: [
    ...
    },
    {
      ...
      period: "2011 – 2016",
      description: "Grunnla og drev digitalt byrå som leverte over 40 nettbutikker og nettsider — blant de første leverandørene av selvbetjente Magento-nettbutikker, først i Norge med WooCommerce.",
      bullets: [
        "Rekrutterte og hadde personalansvar for 6 ansatte, og koordinerte 14+ eksterne utviklere."
      ]
    }
  ],
  education: [
  ...
  skills: [
    "ENDRINGSLEDELSE OG KOORDINERING",
    "ITSM-RELATERT PROSESSARBEID",
